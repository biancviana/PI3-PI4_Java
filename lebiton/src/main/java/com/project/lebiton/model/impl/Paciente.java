...
import com.project.lebiton.dao.impl.UsuarioDao;
...
public class Paciente extends Usuario implements UsuarioInterface {
    ...
    public Paciente(final String email, final String senha) {
        ...
        final UsuarioRepository usuarioPersist = new UsuarioDao();
        usuarioService = new UsuarioService(usuarioPersist);
    }

    public Paciente(final StringProperty nome, final String cpf, final String telefone, final String endereco, final String senha, final String email) {
